...
<legend class="text"><b>STUDENTS LIST</b></legend><br>
	...
	<table border="2" align="center" width="90%">
		...
		<?php while($data =mysqli_fetch_assoc($result)){ ?>
				<tr>
					...
					<a href="sprofileEdit.php?id=<?=$data['id']?>"class="myButton">Edit</a>
			
					<a href="sprofileDelete.php?id=<?=$data['id']?>"class="myButton">Delete</a>
				</td>
				</tr>
		<?php } ?>
