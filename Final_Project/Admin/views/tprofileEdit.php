...
<body>
	<form method="post" action="../controller/editTeacherCheck.php" enctype="multipart/form-data">
	 ...
	 <tr height="50px">
		...
		<tr height="60px" >
			<td colspan="2" align="center">
				...
				<input type="submit" name="submit" value="UPDATE" class="myButton" onmousemove="validatePicture()" onclick="myValidation()">
