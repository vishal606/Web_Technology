...
<legend class="text"><b>LIBRARIANS LIST</b></legend><br>
	...
	<?php while($data =mysqli_fetch_assoc($result)){ ?>
			...
			<tr>
				...
				<td>
					...
					<a href="lprofileEdit.php?id=<?=$data['id']?>"class="myButton">Edit</a>
					
					<a href="lprofileDelete.php?id=<?=$data['id']?>"class="myButton">Delete</a>
				</td>
